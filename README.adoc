...
image:https://deepwiki.com/badge.svg[Ask DeepWiki, link=https://deepwiki.com/robotframework/RIDE]
...
Currently, the unit tests are tested on Python 3.9, 3.10, 3.11. 3.12, 3.13 and 3.14.
...
Linux (Fedora 41/42: py3.13, py3.14, Ubuntu 24.04: py3.9 .. py3.14): image:https://img.shields.io/github/actions/workflow/status/HelioGuilherme66/RIDE/linux.yml[Unit Tests, link=https://github.com/HelioGuilherme66/RIDE/actions/workflows/linux.yml]
