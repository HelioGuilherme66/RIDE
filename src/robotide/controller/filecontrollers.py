...
class _DataController(_BaseController, WithUndoRedoStacks, WithNamespace):
    ...
    def variables(self):
        if self._variables_table_controller is None:
            print(f"DEBUG: Filecontrollers Variable table calling: {self.data}")
            # self._variables_table_controller = VariableTableController(self, self.data.variable_table)
            self._variables_table_controller = VariableTableController(self, self.data.visit(self.data))
            print(f"DEBUG: Filecontrollers Variable table called: {self.data}")
