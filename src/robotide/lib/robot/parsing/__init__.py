...
.. tip:: Like with rest of the public API, these functions and classes are
         ...
         ``from robotide.lib.robot.api import get_tokens``.
...
module, can be used for debugging::
    ...
    from robotide.lib.robot.api import get_model
...
this example that renames keywords::
    ...
    import ast
    from robotide.lib.robot.api import get_model, Token
...
::
    ...
    import ast
    from robotide.lib.robot.api import get_model, Token
    from robotide.lib.robot.parsing.model import SettingSection, Statement
...
::
     ...
     from robotide.lib.robot.api import get_model, TestSuite
