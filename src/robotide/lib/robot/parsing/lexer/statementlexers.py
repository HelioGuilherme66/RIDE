...
from robotide.lib.robot.utils import normalize_whitespace, split_from_equals
from robotide.lib.robot.variables import is_assign, is_dict_variable, search_variable
